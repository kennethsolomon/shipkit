...
4. **Check for Architectural Changes**
   ...
   ```bash
   python3 .claude/../../../../skills/setup-claude/scripts/detect_arch_changes.py --dry-run
   ```
...
6. **Security Gate**
   - If `/security-check` has not been run on this branch, recommend: "Run `/security-check` before creating a PR."
