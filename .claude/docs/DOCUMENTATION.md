...
```bash
cd /path/to/project
python3 "$HOME/.agents/skills/skills/setup-claude/scripts/apply_setup_claude.py" "$(pwd)"
```
...
```bash
python3 "$HOME/.agents/skills/skills/setup-claude/scripts/apply_setup_claude.py" "$(pwd)" --dry-run
```

Print detected values (JSON):

```bash
python3 "$HOME/.agents/skills/skills/setup-claude/scripts/apply_setup_claude.py" "$(pwd)" --print-detection
```

Optional: update previously generated files only (files containing `<!-- Generated by /setup-claude -->`):

```bash
python3 "$HOME/.agents/skills/skills/setup-claude/scripts/apply_setup_claude.py" "$(pwd)" --update-generated
```

**What it does:**
- Detects basic stack info (from `package.json` and common config files)
- Renders templates from `~/.agents/skills/skills/setup-claude/templates/`
...
python3 ~/.agents/skills/skills/setup-claude/scripts/apply_setup_claude.py "$(pwd)"
```
