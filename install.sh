...
echo "  /sk:dashboard       — Read-only workflow Kanban board (localhost)"
echo "  /sk:context         — Load context + session brief (run at session start)"
...
echo "  /sk:scope-check     — Compare implementation against plan, detect scope creep"
echo "  /sk:retro           — Post-ship retrospective: velocity, blockers, action items"
echo "  /sk:reverse-doc     — Generate architecture/design docs from existing code"
echo ""
